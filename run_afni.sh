...
echo "auto-generated by afni_proc.py, Mon Oct 22 23:14:10 2018"
echo "(version 6.19, September 18, 2018)"
echo "execution started: `date`"

# execute via : 
#   tcsh -xef run_afni.sh |& tee output.run_afni.sh
...
cp /scratch/psyc5171/eay15101/hw7/Finger.txt \
    /scratch/psyc5171/eay15101/hw7/Foot.txt  \
    /scratch/psyc5171/eay15101/hw7/Lips.txt $output_dir/stimuli

# copy anatomy to results dir
3dcopy                                                                         \
    /scratch/psyc5171/dataset1/sub-02/ses-test/anat/sub-02_ses-test_T1w.nii.gz \
    $output_dir/sub-02_ses-test_T1w

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 0 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    /scratch/psyc5171/dataset1/sub-02/ses-test/func/sub-02_ses-test_task-fingerfootlips_bold.nii.gz'[0..$]'
...
# (new anat will be intermediate, stripped, sub-02_ses-test_T1w_ns+orig)
align_epi_anat.py -anat2epi -anat sub-02_ses-test_T1w+orig \
...
@auto_tlrc -base MNI_avg152T1+tlrc -input sub-02_ses-test_T1w_ns+orig -no_ss

# store forward transformation matrix in a text file
cat_matvec sub-02_ses-test_T1w_ns+tlrc::WARP_DATA -I > warp.anat.Xat.1D

# ================================= volreg =================================
# align each dset to base volume, align to anat, warp to tlrc space

# verify that we have a +tlrc warp dataset
if ( ! -f sub-02_ses-test_T1w_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: sub-02_ses-test_T1w_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                         \
               sub-02_ses-test_T1w_ns+tlrc::WARP_DATA -I        \
               sub-02_ses-test_T1w_al_junk_mat.aff12.1D -I      \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc
    3dAllineate -base sub-02_ses-test_T1w_ns+tlrc               \
...
3dcopy sub-02_ses-test_T1w_ns+tlrc anat_final.$subj
...
3dAllineate -source sub-02_ses-test_T1w+orig                    \
...
3dresample -master full_mask.$subj+tlrc -input sub-02_ses-test_T1w_ns+tlrc \
...
#
# afni_proc.py -subj_id 02 -script run_afni.sh -scr_overwrite -blocks tshift                          \
#     align tlrc volreg blur mask scale regress -copy_anat                                            \
#     /scratch/psyc5171/dataset1/sub-02/ses-test/anat/sub-02_ses-test_T1w.nii.gz                      \
#     -dsets                                                                                          \
#     /scratch/psyc5171/dataset1/sub-02/ses-test/func/sub-02_ses-test_task-fingerfootlips_bold.nii.gz \
#     -tcat_remove_first_trs 0 -tshift_opts_ts -tpattern alt+z -tlrc_base                             \
...
#     /scratch/psyc5171/eay15101/hw7/Foot.txt                                                         \
#     /scratch/psyc5171/eay15101/hw7/Lips.txt -regress_stim_labels Finger                             \
